...
-- Paso 1: Eliminar la restricci├│n de clave for├ínea actual
...
-- Paso 3: Agregar nuevamente la clave for├ínea con ON DELETE SET NULL
...
-- Descomenta la siguiente l├¡nea si quieres que el super-admin no est├® asociado a ning├║n restaurante
